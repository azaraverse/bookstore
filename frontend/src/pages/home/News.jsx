...
const News = () => {
  return (
    <div className='py-16'>
      <h2 className='text-3xl font-primary font-semibold mb-6'>News</h2>
        ...
        news.map((item, index) => (
          <SwiperSlide key={index}>
            <div className='flex flex-col sm:flex-row sm:justify-between items-center gap-12'>
              ...
              <div className='py-4'>
                <Link to='/'>
                  <h3 className='text-lg font-primary font-medium hover:text-blue-500 hover:cursor-pointer mb-4'>{item.title}</h3>
                </Link>
              ...
              <div className='flex-shrink-0'>
                <img src={item.image} alt="News Image" className='w-full object-cover'/>
              </div>
            </div>
          </SwiperSlide>
