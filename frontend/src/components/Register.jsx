  ...
  return (
    <div className='h-[calc(100vh-120px)] flex justify-center items-center'>
      <div className='w-full md:max-w-sm mx-auto bg-white shadow-md rounded-lg px-8 pt-6 pb-8 mb-4'>
        <h2 className='text-xl font-primary font-semibold mb-4'>Register to place orders</h2>
        ...
        <p className='align-baseline font-medium mt-4 font-primary text-sm'>
          Already have an account? <Link to="/login" className='text-blue-700 hover:text-blue-900'>Login</Link>
        </p>
